/*
SPDX-FileCopyrightText: 2023 SAP SE or an SAP affiliate company and image-mapper-cop contributors
...
const Name = "image-mapper-cop.cs.sap.com"
...
func (o *Operator) GetUncacheableTypes() []client.Object {
	return []client.Object{&operatorv1alpha1.ImageMapper{}}
}
...
func (o *Operator) Setup(mgr ctrl.Manager, discoveryClient discovery.DiscoveryInterface) error {
	...
	if err := component.NewReconciler[*operatorv1alpha1.ImageMapper](
		o.options.Name,
		mgr.GetClient(),
		discoveryClient,
